...
@section('content')
                            ...
                            <form id="caloriesForm" method="post" action="{{ route('calories-update') }}">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="calorieList_id" value="{{ $calorie->id }}" />
                                                ...
                                                <select name="subgroup" id="subgroup_id" class="form-control select2bs4"
                                                    ...
                                                    @foreach ($subgroups as $group)
                                                        <option value="{{ $group->id }}"
                                                            {{ $calorie->subgroup_id == $group->id ? 'selected' : '' }}>
                                                            {{ $group->name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="macro" id="macro_id" class="form-control select2bs4"
                                                    ...
                                                    @foreach ($macros as $macro)
                                                    <option value="{{ $macro->id }}"
                                                        {{ $calorie->macro_id == $macro->id ? 'selected' : '' }}>
                                                        {{ $macro->name }}</option>
                                                @endforeach
                                                    <!-- <option selected="selected">Alabama</option>
                                                                                    <option disabled="disabled">California (disabled)</option> -->
    ...
    @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="servingsize" id="servingsize" class="form-control select2bs4"
                                                    ...
                                                    @foreach ($servingsizes as $size)
                                                        <option {{ $calorie->serving == $size->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-12" id="addSection">
                                            @foreach ($calorie->calCaloriesField as $counasData)
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select2-purple">
                                                                <select name="countas[]" class="form-control select2bs4 "
                                                                    ...
                                                                    @foreach ($macros as $macro)
                                                                        <option value="{{ $macro->id }}"
                                                                            {{ $counasData->macro_id == $macro->id ? 'selected' : '' }}>
                                                                            {{ $macro->countas }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
