            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="subMacroForm" method="post" action="{{route('sub-macro-update')}}">
                            @csrf
                            <input type="hidden" name="submacro_id" value="{{$submacro->id}}" />
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="group" class="form-control select2bs4" style="width: 100%;">
                                                ...
                                                <option value="{{$group->id}}" {{ $submacro->group_id==$group->id ?
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="{{$submacro->name}}"
