                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"> <small>Edit Macro</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="macroForm" method="post" action="{{route('macro-update')}}">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="subgroup" class="form-control select2bs4" style="width: 100%;">
                                                ...
                                                <option value="{{$group->id}}" {{ $macro->group_id ==$group->id ?
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="macro_name" class="form-control" id="macro_name" value="{{$macro->name}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="carbohydrate" class="form-control" value="{{$macro->carbohydrate}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="protein" class="form-control" id="protein" value="{{$macro->protein}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fat" class="form-control" id="fat" value="{{$macro->fat}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="calories" class="form-control" id="calories" value="{{$macro->calories}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="countas" class="form-control" id="countas"  value="{{$macro->countas}}"
