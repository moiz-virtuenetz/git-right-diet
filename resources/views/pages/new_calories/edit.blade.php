                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><small>Edit Calories</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="caloriesForm" method="post" action="{{route('calories-update')}}">
                            @csrf
                            <input type="hidden" name="calorie_id" value="{{$calorie->id}}" />
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="group" id="group_id" class="form-control select2bs4"
                                                ...
                                                <option value="{{$group->id}}" {{ $calorie->group_id==$group->id ?
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="food_name" class="form-control" id="food_name"
                                                value="{{$calorie->name}}" placeholder="enter food name">
                                            @error('food_name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="serving" class="form-control"
                                                value="{{$calorie->serving}}" id="serving" placeholder="enter serving">
                                            @error('serving')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="count_as" class="form-control" id="count_as"
                                                value="{{$calorie->count_as}}" placeholder="enter count as">
                                            @error('count_as')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
        ...
        $('#caloriesForm').validate({
            ...
            messages: {
                ...
                serving: {
                    ...
                    minlength: "Your serving size must be at least 3 characters long",
                    maxlength: "Your serving size not exceed than 100 characters"
                },
                count_as: {
